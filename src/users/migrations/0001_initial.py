    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.CharField(blank=True, max_length=20, null=True, unique=True, verbose_name='ID Владельца (ручной ввод)')),
                ('middle_name', models.CharField(blank=True, max_length=150, verbose_name='Middle name')),
                ('user_type', models.CharField(choices=[('employee', 'Сотрудник'), ('owner', 'Владелец')], default='employee', max_length=10, verbose_name='Type of user')),
